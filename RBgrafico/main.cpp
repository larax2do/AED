...
{
    GObject *box;
    ArbolRB2<std::string> arbo;
    GtkWidget *img;
    GObject *gri;
    datis(GObject *b,GtkWidget *i,GObject *g,ArbolRB2<std::string> &a):box{b},arbo{a},img{i},gri{g}{}
};
